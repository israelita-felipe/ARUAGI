...
import br.edu.uag.aruagi.model.Facade.NivelQuestaoFacade;
...
public class NivelQuestaoController implements Serializable {

    private NivelQuestaoFacade facade = new NivelQuestaoFacade();
