 ...
 */
@Stateless
public class ClassificacaoGramaticalFacade extends AbstractFacade<ClassificacaoGramatical, Integer> implements Serializable{

    public ClassificacaoGramaticalFacade() {
