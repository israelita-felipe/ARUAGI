...
public class CasoAplicadoController implements Serializable, InterfaceController<CasoAplicado, CasoAplicadoId> {
    ...
    @Override
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("MensagemCasoAplicadoCriado"));
    }

    @Override
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("MensagemCasoAplicadoAtualizado"));
    }

    @Override
    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("MensagemCasoAplicadoExcluido"));
    }
