...
/**
 * IndicadorTempoVerbal generated by hbm2java
 */
@Entity
@Table(name = "indicador_tempo_verbal", schema = "public"
)
public class IndicadorTempoVerbal implements java.io.Serializable {

    private IndicadorTempoVerbalId id;
    ...
    public IndicadorTempoVerbal() {
    }

    public IndicadorTempoVerbal(IndicadorTempoVerbalId id, PessoaGramatical pessoaGramatical, TempoVerbal tempoVerbal, String descricao) {
        this.id = id;
    ...
    public IndicadorTempoVerbal(IndicadorTempoVerbalId id, PessoaGramatical pessoaGramatical, TempoVerbal tempoVerbal, String descricao, Integer usuario) {
        this.id = id;
        this.pessoaGramatical = pessoaGramatical;
        this.tempoVerbal = tempoVerbal;
        this.descricao = descricao;
    ...
    public IndicadorTempoVerbalId getId() {
        return this.id;
    }

    public void setId(IndicadorTempoVerbalId id) {
        this.id = id;
    }
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + (this.pessoaGramatical != null ? this.pessoaGramatical.hashCode() : 0);
        hash = 59 * hash + (this.tempoVerbal != null ? this.tempoVerbal.hashCode() : 0);
    ...
    public boolean equals(Object obj) {
        ...
        final IndicadorTempoVerbal other = (IndicadorTempoVerbal) obj;
