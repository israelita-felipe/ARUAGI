 ...
 */
@Stateless
public class DeclinacaoAplicadaFacade extends AbstractFacade<DeclinacaoAplicada, DeclinacaoAplicadaId> implements Serializable{

    public DeclinacaoAplicadaFacade() {
